...
asmlinkage long sys_futex_wake(void __user *uaddr, unsigned long mask, int nr,
			       unsigned int flags);
...
asmlinkage long sys_futex_requeue(struct futex_waitv __user *waiters,
				  unsigned int flags, int nr_wake,
				  int nr_requeue);
...
asmlinkage long sys_map_shadow_stack(unsigned long addr, unsigned long size,
				     unsigned int flags);
asmlinkage long sys_lsm_get_self_attr(unsigned int attr,
				      struct lsm_ctx __user *ctx,
				      u32 __user *size, u32 flags);
asmlinkage long sys_lsm_set_self_attr(unsigned int attr,
				      struct lsm_ctx __user *ctx, u32 size,
				      u32 flags);
...
asmlinkage long sys_hello(unsigned long pid, unsigned long va,
